 ...
 */
final class Version20200616135140 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE media_product (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, uid CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', path VARCHAR(255) DEFAULT NULL, INDEX IDX_B29D82E44584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE media_product ADD CONSTRAINT FK_B29D82E44584665A FOREIGN KEY (product_id) REFERENCES product (id)');
    }
